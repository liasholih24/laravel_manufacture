...
class PenjualanController extends Controller
{
    ...
    {
        $data = DB::table('penjualans')->join('detailpenjualans', 'penjualans.id', '=', 'detailpenjualans.penjualan_id')->selectRaw('penjualans.date, penjualans.number, penjualans.desc, sum(detailpenjualans.qty) as qty, sum(detailpenjualans.price) as price')->where('detailpenjualans.deleted_at', null)->where('penjualans.deleted_at', null)->where('penjualans.storage_id', $request->storage_id)->whereRaw('penjualans.date between "'.$request->from_date.'" and "'.$request->to_date.'"')->groupBy(['penjualans.id', 'penjualans.date', 'penjualans.number', 'penjualans.desc'])->get();
