...
# Aplikasi Manufacturing 1.0 , KS Farm

## Starter Site based on Aplikasi Manufacture 1.0
* [Features](#feature1)
...
### Step 1:  Clone this repository:
    git clone https://kelinci1@bitbucket.org/salingka_dev/laravel_manufacture.git
...
If you install on your localhost in folder pdk_abah, you can type on web browser:

	http://localhost/pdk_abah/public
