...
<div class="wrapper wrapper-content">
    ...
    <div class="ibox-title row">
        <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
          ...
          <a href="<?php echo e(url('item/1/create')); ?>">
          ...
          <select class="form-control chosen-select" style="max-width:265px;margin-right: 10px;" onchange="if (this.value) window.location.href=this.value">
						<option value="<?php echo e(url('item')); ?>">Pilih Kategori</option>
						<?php $__currentLoopData = $filters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e(url('item/' . $filter->id . '/filter')); ?>" <?php if ($filter->id == $id) echo ' selected="selected"'; ?>>
...
<tbody>
  ...
  <tr>
      ...
      <td><?php echo empty($table->expire_date)?"<i>Not Set</i>": $table->expire_date; ?></td>
