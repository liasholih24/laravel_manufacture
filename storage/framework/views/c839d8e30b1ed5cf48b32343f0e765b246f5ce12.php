...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="">
            <a href="<?php echo e(url('pembelian')); ?>">  Pembelian
        </li>
        /
        <li class="">
                <a href="#">
...
<div class="row ibox-content" style="min-height: 65vh; ">
  ...
  <?php echo Form::model($pembelian, [
      'method' => 'PATCH',
      'url' => ['pembelian', $pembelian->id],
    ...
    <div class="form-group <?php echo e($errors->has('norek') ? 'has-error' : ''); ?>">
                ...
                <select name="gudang" class="col-sm-12 form-control Gudang chosen-select" style="width:350px;" tabindex="2" id="gudang" data-fplaceholder="Gudang">
                                  ...
                                  <?php $__currentLoopData = $gudangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gudang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($gudang->id); ?>" <?php if($pembelian->gudang == $gudang->id)echo"selected";?>><?php echo e($gudang->code); ?> - <?php echo e($gudang->name); ?></option>
            ...
            <div class="hr-line-dashed"></div> 
               <div class="form-group <?php echo e($errors->has('norek') ? 'has-error' : ''); ?>">
                <?php echo Form::label('name', 'Nama*', ['class' => 'col-sm-2 control-label']); ?>

                <div class="col-sm-8">
                
                    <?php echo Form::text('name', null, ['class' => 'form-control','id'=>'name','placeholder'=>'Nama Pembeli']); ?>
        ...
        <div class="form-group ">
            ...
            <?php echo Form::hidden('code', $pembelian->code, ['class' => 'form-control','id'=>'code']); ?>
 ...
 <div class="hr-line-dashed"></div> 
    <div class="row clearfix">
        ...
        <tbody>
            ...
            <td data-name="satuan">
                <select  name="satuan[]" class="form-control Satuan" data-placeholder="Pilih Satuan" id="satuan" style="width:200px;">
                     <?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <td data-name="harga_beli">
                <?php echo Form::number('harga_beli[]', $detail->harga_beli, ['class' => 'form-control HJ HJ2']); ?>
...
// DYNAMIC TABLE
  $("#add_row").on("click", function() {
     ...
     if ($(this).find(':selected').val() != '') {
      ...
      if ($(this).find(':selected').val() != '') { 
      var val     = $(this).find(':selected').val(),
          url     = '<?php echo e(url("/refpj?perusahaan=")); ?>'+val;
