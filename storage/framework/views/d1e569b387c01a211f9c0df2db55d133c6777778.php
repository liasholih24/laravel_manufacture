...
<div class="row ibox-content" style="min-height: 65vh; ">
    ...
    <?php echo Form::open(['url' => 'organization', 'class' => 'form-horizontal']); ?>
...
<div class="form-group">
  <?php echo Form::label('category', 'Structure* ', ['class' => 'col-sm-2 control-label']); ?>

  <div class="col-sm-4 col-xs-12 <?php echo e($errors->has('kategori') ? 'has-error' : ''); ?>">
  <select class="form-control m-b" name="kategori">
		<?php if($id == ""): ?>
  	<option value="uncategories">Select Structure</option>
		<?php endif; ?>
...
<?php echo $errors->first('status', '<p class="help-block">:message</p>'); ?>
            ...
            <div class="form-group">
										<?php echo Form::label('code', 'Org Code*', ['class' => 'col-sm-2 control-label']); ?>
		                ...
		                <div class="col-sm-4 col-xs-12 <?php echo e($errors->has('code') ? 'has-error' : ''); ?>">
		                    ...
		                    <?php echo $errors->first('code', '<p class="help-block">:message</p>'); ?>
										...
										<?php echo Form::label('name', 'Org Name*', ['class' => 'col-sm-2 control-label']); ?>
