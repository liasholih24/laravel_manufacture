...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="">
            <a href="<?php echo e(url('penjualan')); ?>"> Transfer Sampah</a>
        </li>
...
<div class="row ibox-content" style="min-height: 65vh; ">
    ...
    <?php echo Form::open(['url' => 'transfer', 'class' => 'form-horizontal']); ?>
    ...
    <div class="form-group <?php echo e($errors->has('gdg_from') ? 'has-error' : ''); ?>">
                <?php echo Form::label('gdg_from', 'Gudang Asal*', ['class' => 'col-sm-2 control-label']); ?>
                ...
                <select name="gdg_from" class="col-sm-12 form-control Gudangf chosen-select" style="width:350px;" tabindex="2" id="gdg_from" data-fplaceholder="Gudang Asal">
                    ...
                    <?php echo $errors->first('gdg_from', '<p class="help-block">:message</p>'); ?>

                </div>                       
            </div> 
            <div class="hr-line-dashed"></div> 
               <div class="form-group <?php echo e($errors->has('gdg_to') ? 'has-error' : ''); ?>">
                <?php echo Form::label('gdg_to', 'Gudang Tujuan*', ['class' => 'col-sm-2 control-label']); ?>
                ...
                <select name="gdg_to" class="col-sm-12 form-control Gudangt chosen-select" style="width:350px;" tabindex="2" id="gdg_to" data-fplaceholder="Gudang Tujuan">
                    ...
                    <?php echo $errors->first('gdg_to', '<p class="help-block">:message</p>'); ?>
    ...
    <div class="row clearfix">
        ...
        <tfoot>
           <tr>
            ...
            <td colspan="1">
                <?php echo Form::number('qty_kg', null, ['class' => 'form-control','readonly'=>'readonly','id'=>'qty_kg']); ?>
