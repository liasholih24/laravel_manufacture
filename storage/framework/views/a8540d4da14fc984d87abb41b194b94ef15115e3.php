...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="">
            <a href="<?php echo e(url('penjualan')); ?>">  Penjualan
        </li>
        /
        <li class="">
                <a href="#">
...
<div class="row ibox-content" style="min-height: 65vh; ">
  ...
  <?php echo Form::model($penjualan, [
      'method' => 'PATCH',
      'url' => ['penjualan', $penjualan->id],
    ...
    <div class="form-group <?php echo e($errors->has('norek') ? 'has-error' : ''); ?>">
                ...
                <select name="gudang" class="col-sm-12 form-control Gudang chosen-select" style="width:350px;" tabindex="2" id="gudang" data-fplaceholder="Gudang">
                                  ...
                                  <?php $__currentLoopData = $gudangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gudang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($gudang->id); ?>" <?php if($penjualan->gudang == $gudang->id)echo"selected";?>><?php echo e($gudang->code); ?> - <?php echo e($gudang->name); ?></option>
            ...
            <div class="hr-line-dashed"></div> 
               <div class="form-group <?php echo e($errors->has('norek') ? 'has-error' : ''); ?>">
                <?php echo Form::label('perusahaan', 'Perusahaan*', ['class' => 'col-sm-2 control-label']); ?>

                <div class="col-sm-8">
                 <?php echo Form::text('perusahaan',null, ['class' => 'form-control','placeholder' => 'Nama Bandar/Perusahaan.']); ?>
        ...
        <div class="form-group ">
            ...
            <?php echo Form::hidden('code', $penjualan->code, ['class' => 'form-control','id'=>'code']); ?>
 ...
 <div class="hr-line-dashed"></div> 
    <div class="row clearfix">
        ...
        <tbody>
            ...
            <td data-name="sampah">
              <select  name="sampah[]" class="form-control Sampah  chosen-select" data-placeholder="Pilih Sampah" id="sampah" style="width:250px;">
                    <option value=""></option>
            ...
            <td data-name="harga_beli">
                <?php echo Form::number('harga_jual[]', null, ['class' => 'form-control HJ HJ2']); ?>
           ...
           <?php $i++; ?>
            <tr id='addr<?php echo e($i); ?>' data-id="<?php echo e($i); ?>">
               <td data-name="del">
                <button nam"del0" class='btn btn-default btn-xs glyphicon glyphicon-remove row-remove'></button>
            </td>
            <td data-name="sampah">
              <select  name="sampah[]" class="form-control Sampah" data-placeholder="Pilih Sampah" id="sampah" style="width:250px;">
                     <?php $__currentLoopData = $sampahs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sampah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($sampah->id); ?>" <?php if($detail->sampah == $sampah->id)echo"selected";?>><?php echo e($sampah->code); ?> - <?php echo e($sampah->name); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                </select>

            </td>
            <td data-name="satuan">
                <select  name="satuan[]" class="form-control Satuan" data-placeholder="Pilih Satuan" id="satuan<?php echo e($i); ?>" style="width:200px;">
                     <?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($satuan->code); ?>" <?php if($detail->satuan == $satuan->code)echo"selected";?>><?php echo e($satuan->name); ?></option>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>  
                </select>

            </td>
            <td data-name="jumlah">
                <?php echo Form::number('jumlah[]', $detail->jumlah, ['class' => 'form-control Jumlah','step'=>'any', 'id'=>'jumlah<?php echo e($i); ?>']); ?>

                 </td>
            <td data-name="harga_jual">
                <?php echo Form::number('harga_jual[]', $detail->harga_jual, ['class' => 'form-control HJ','id'=>'harga_jual1']); ?>


            </td>
            <td data-name="nilai_kg">
                <?php echo Form::number('nilai_kg[]', $detail->nilai_kg, ['class' => 'form-control Nkg','readonly'=>'readonly']); ?>

            </td>
            <td data-name="nilai_rp">
                <?php echo Form::number('nilai_rp[]', $detail->nilai_rp, ['class' => 'form-control Nrp','readonly'=>'readonly']); ?>
        ...
        <div class="hr-line-dashed"></div> 
    <div class="form-group">
    <a href="<?php echo e(url('penjualan')); ?>" class="detail2 btn btn-md btn-outline btn-default pull-right">  <i class="fa fa-times-circle" ></i> Cancel</a>
...
/*
        $(tr).find("td select.Sampah").on('change', function(e){
           ...
           var  url     = "<?php echo e(url("/cekstock?sampah=")); ?>"+val+"&gudang="+gudang;
          ...
          $("#harga_jual1").on('change', function(e){
