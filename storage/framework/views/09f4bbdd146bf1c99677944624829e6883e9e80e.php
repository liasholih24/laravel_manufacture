...
<?php $__env->startSection('content'); ?>
	<div class="big-screen" ><img src="images/iconplus.jpg" class="img-responsive" style="transform: scaleX(-1); height: 100vh; width: 80%; position: absolute;">
       	<div style="width: 30%; background-color: #ffffff; height: 100vh; position: relative;" class="pull-right">
	       	<div class="middle-box text-center loginscreen"  style="margin-top: 35%">
		        <div class-="col-md-12" >
		            <h2 style="font-size: 36px"><strong>AMARTA</strong></h2>
