                    ...
                    <div class="ibox-content p-xl">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <h4 class="text-navy"><?php echo e($penjualan->code); ?> </h4>
                                    <address>
                                        <h4><strong><?php echo e($penjualan->getperusahaan->name); ?></strong></h4>
                                    </address>
                                    <p>
                                       
                                        <span><strong>Tgl:</strong> <?php echo e($penjualan->created_at); ?></span>
                                    </p>
                                </div>
                            </div>
                                    ...
                                    <tbody>
                                      <?php $__currentLoopData = $details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                       <tr>
                                         ...
                                         <td><?php echo e(number_format($detail->harga_jual,0)); ?></td>
                            ...
                            <table class="table invoice-total">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(number_format($penjualan->total_rp,0)); ?></td>
                                </tr>
                                <tr>
                                    <td><strong>Total (kg) :</strong></td>
                                    <td><?php echo e(number_format($penjualan->total_kg)); ?></td>
                                </tr>
