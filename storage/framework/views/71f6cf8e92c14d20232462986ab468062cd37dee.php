...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
    ...
    <a href="<?php echo e(url('transfer/create')); ?>">
...
<?php $i++ ?>
    <tr>
        ...
        <td><?php echo e($item->gudangfrom->name); ?></td>
        <td><?php echo e($item->gudangto->name); ?></td>
        <td><?php echo e($item->qty_kg); ?></td>
        ...
        <td>
            <a href="<?php echo e(url('transfer/' . $item->id . '/print')); ?>" 
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php else: ?>
         <div class="jumbotron">
                        ...
                        <p><a href="<?php echo e(url('transfer/create')); ?>" class="btn btn-primary btn-lg" role="button">Tambah Transfer</a>
                        </p>
        </div>
        <?php endif; ?>
      </div>
