                    ...
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <small>Total Deposit dari 1000 nasabah</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins">1500</h1>
                                
                                <small>Total 1000 dari seluruh nasabah</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                                ...
                                <div class="col-lg-3">
                                    <ul class="stat-list">
                                        <li>
                                            ...
                                            <small>Total deposit in period</small>
                                        ...
                                        <li>
                                            ...
                                            <small>Total Active Nasabah</small>
                                        ...
                                        <li>
                                            ...
                                            <small>Penjualan in last month</small>
                        ...
                        <div class="col-lg-4">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <h5>Aktifitas Log</h5>
                                        <div class="ibox-tools">
                                            <span class="label label-warning-light pull-right">10 Logs</span>
                                           </div>
                                    </div>
                                    <div class="ibox-content">
                                        ...
                                        <div>
                                            ...
                                            <button class="btn btn-primary btn-block m-t">Selengkapnya </button>
