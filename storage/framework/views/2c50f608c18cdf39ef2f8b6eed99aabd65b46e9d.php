...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="">
            <a href="<?php echo e(url('penjualan')); ?>"> Penjualan</a>
        </li>
...
<div class="row ibox-content" style="min-height: 65vh; ">
    ...
    <?php echo Form::open(['url' => 'penjualan', 'class' => 'form-horizontal']); ?>
    ...
    <div class="form-group <?php echo e($errors->has('norek') ? 'has-error' : ''); ?>">
        ...
        <div class="form-group ">
            ...
            <?php echo Form::hidden('code', null, ['class' => 'form-control','id'=>'code']); ?>
...
// DYNAMIC TABLE
  $("#add_row").on("click", function() {
     ...
     /*   $(tr).find("td select.Sampah").on('change', function(e){
          ...
          $(tr).find("td input.HJ").on('keyup', function(e){
      ...
      var val     = $(this).find(':selected').val(),
          url     = '<?php echo e(url("/refpj?gudang=")); ?>'+val;
