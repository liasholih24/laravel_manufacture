...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
    ...
    <a href="<?php echo e(url('penjualan/create')); ?>">
    <button class="detail2 btn btn-sm btn-outline btn-success pull-right" style="margin-right: 10px">
        <i class="fa fa-plus-circle" style="margin-right: 5px"></i> Tambah Penjualan
    </button>
  </a>
</div>
...
<?php $i++ ?>
    <tr>
        ...
        <td><?php echo empty($item->perusahaan)?"<i>Tidak ada data</i>": $item->perusahaan; ?></td>
        ...
        <td>
            <a href="<?php echo e(url('penjualan/' . $item->id . '/print')); ?>" class="btn btn-outline btn-success btn-xs" target="_blank">Cetak Bukti</a>
            <a href="<?php echo e(url('penjualan/' . $item->id . '/edit')); ?>" class="btn btn-outline btn-primary btn-xs" target="_blank">Edit</a>
             <?php echo Form::open([
                'method'=>'DELETE',
                'url' => ['penjualan', $item->id],
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="jumbotron">
                        <h1>Data Kosong ... </h1>
                        <p>Mohon maaf, tidak ada data transaksi penjualan untuk hari ini.</p>
                        <p><a href="<?php echo e(url('penjualan/create')); ?>" class="btn btn-primary btn-lg" role="button">Tambah Penjualan</a>
                        </p>
        </div>
        <?php endif; ?>
      </div>
