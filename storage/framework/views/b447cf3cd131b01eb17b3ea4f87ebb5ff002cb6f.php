        ...
        <div class="item active">
            <div class="container">
                <div class="carousel-caption blank">
                    ...
                    <p style="color:#19aa8d;">Selamat Bekerja, <?php echo e(Sentinel::getUser()->first_name); ?> !</p>
                    <?php endif; ?>
                    ...
                    <?php if(Route::has('login')): ?>
                       <?php if(Sentinel::check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="btn btn-lg btn-primary" role="button">Dashboard</a>
                            <?php else: ?>
                            <a href="<?php echo e(url('/login')); ?>" class="btn btn-lg btn-primary" role="button">Login ke akun</a>
                            <?php endif; ?>
                            <?php endif; ?>
                    </p>
                </div>
