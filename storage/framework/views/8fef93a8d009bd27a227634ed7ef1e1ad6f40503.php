    ...
    <div class="row clearfix">
        ...
        <tbody>
           ...
           <?php $i++; ?>
            ...
            <td data-name="jumlah">
                <?php echo Form::number('jumlah[]', $detail->jumlah, ['class' => 'form-control Jumlah','step'=>'any']); ?>

                 </td>
            <td data-name="harga_jual">
                <?php echo Form::number('harga_jual[]', $detail->harga_jual, ['class' => 'form-control HJ']); ?>
...
/*
        $(tr).find("td select.Sampah").on('change', function(e){
          ...
          $(tr).find("#harga_jual1").on('change', function(e){
