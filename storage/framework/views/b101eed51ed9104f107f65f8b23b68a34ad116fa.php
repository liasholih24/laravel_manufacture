          ...
          <div class="col-xs-12 col-sm-12">
            ...
            <div class="form-group">
                ...
                <div class="input-group col-sm-12 col-xs-12 ">
                  <select class="form-control m-b" name="kategori" disabled>
                    <?php if($node->nesting != 0): ?>
                  	<option value="<?php echo e($node->parent_id); ?>" selected><?php echo e($node->parent()->get()->first()->name); ?></option>
                    <?php endif; ?>
              ...
              <div class="col-sm-5 col-xs-12">
                <div class="input-group col-sm-12 col-xs-12 ">
                  <?php echo e(Form::select('status', $activations, $node->status, ['class' => 'form-control select2_demo_1'])); ?>
