                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content row"  style="min-height: 135px !important">
                        <div class="row col-sm-12">
                             <h1 class="m-xs text-center font-bold" id="investInfo" style="color: rgba(240, 90, 34, 0.65) !important">Rp.<?php echo e(number_format($asset->investasi,2,',','.')); ?></h1>
                        </div>
                        <div class="row col-sm-12 " style="padding-top: 10px">
                             <h4 id="investData" style="text-align: center">On <?php echo e($assetnull->asset_ttl); ?> from <?php echo e($asset->asset_ttl); ?> Assets</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-content row"  style="min-height: 155px !important; max-height: 155px">
                       <div class="col-sm-12 text-center">
                             <h2 class="m-xs text-center font-bold" id="assetsTot" style="font-size: 18px"><?php echo e($asset->asset_ttl); ?></h2>
                        </div>
                        <div class="col-sm-12" style="padding-top: 10px">
                             <h4 id="assetsInfo"  style="text-align: center">From <?php echo e($sbu->pop_ttl-$popCustomer); ?> POP <br>and <?php echo e($popCustomer); ?> Customer Site <br>in all SBU</h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content row"  style="min-height: 155px !important">
                       <div class="col-sm-12 text-center">
                             <h1 class="m-xs text-center font-bold"  style="font-size: 18px" id="percentPort"><?php $percent = ($usedPort/$allPort)*100; echo number_format($percent,2,',','.') ;?>%</h1>
                        </div>
                        <div class="col-sm-12" style="padding-top: 10px">
                    ...
                    <div class="ibox-content row" style="min-height: 155px !important">
                        <div class="row text-center col-sm-12">
                             <h2 class="m-xs font-bold" style="font-size: 18px" id="orderInfo">
                                <?php if($workorder->pop_fin != 0): ?>
                                    <?php echo e(round(($workorder->pop_fin / $sbu->pop_ttl)*100)); ?>%
                                <?php elseif( ( ($workorder->pop_fin / $sbu->pop_ttl) > 20) && ( ($workorder->pop_fin / $sbu->pop_ttl) < 50)): ?>
                                    <strong><?php echo e(round(($workorder->pop_fin / $sbu->pop_ttl)*100)); ?>%</strong> Completed
                                <?php else: ?>
                        ...
                        <div class="row col-sm-12" style="padding-top: 10px">
                             <h4 id="orderData" style="text-align: center">From <?php echo e($workorder->wo_ttl); ?> work order</h4>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-3">
            <div class="col-sm-12">
                <div class="ibox">
                    ...
                    <div class="ibox-content row"  style="min-height: 155px !important">
                       <div class="col-sm-12 text-center">
                             <h1 class="m-xs text-center font-bold"  style="font-size: 18px" id="actUser"><?php echo e($activeUser); ?></h1>
                        </div>
                        <div class="col-sm-12" style="padding-top: 10px">
                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row col-lg-3">
                            <ul class="stat-list" style="margin-top: 50px">
                                ...
                                <li>
                                    <h2 class="no-margins "><?php echo e($asset->asset_ttl); ?></h2>
                                ...
                                <li>
                                 ...
                                 <li>
                                    <h2 class="no-margins ">Rp.<?php echo e(number_format($asset->investasi,2,',','.')); ?></h2>
...
<script type="text/javascript" id="mapsDashboard">
    ...
    function initMap() {
        var DKI = {lat: -1.2467423194 , lng: 116.99};
        ...
        var markers = [
          <?php $__currentLoopData = $sbus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ['<?php echo e($d->name); ?>', <?php echo e($d->lat); ?>,<?php echo e($d->lon); ?>, '<?php echo e($d->desc); ?>' , 'sbu',<?php echo e($d->id); ?>],
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ];
        var markers, i;
        for (i = 0; i < markers.length; i++) {
            ...
            google.maps.event.addListener(marker, 'click', (function(marker, i, infoWindow) {
                return function() {
                    ...
                    map.setZoom(6);
                    addMarker(markers[i][5]);
                    detail('sbu',+ markers[i][5]);
                  }
        ...
        function addMarker(d){
            var pops = [
              <?php $__currentLoopData = $pops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ['<?php echo e($p->name); ?>', <?php echo e($p->lat); ?>,<?php echo e($p->lon); ?>, '<?php echo e($p->desc); ?>' , 'pop',<?php echo e($p->id); ?>,<?php echo e($p->sbu_id); ?>, '<?php echo e(str_replace("\n"," ",$p->address)); ?>'],
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ];
            var pid = d;
            var pops, o;
            for (o = 0; o < pops.length; o++) {
                if(pops[o][6] == pid){
                    var position = new google.maps.LatLng(pops[o][1], pops[o][2]);
                    bounds.extend(position);
                    pop = new google.maps.Marker({
                        position: position,
                        map: map,
                        lat: pops[o][1],
                        long: pops[o][2],
                    ...
                    google.maps.event.addListener(pop, 'click', (function(pop, o, infoWindow) {
                        return function() {
                            //console.log('Klick! Marker=' + this.title);
                            var infoWindow = new google.maps.InfoWindow();
                             var contentString = '<div id="siteNotice" style="max-width: 300px !important">'+
                            ...
                            '<h1 id="firstHeading" class="firstHeading">'+this.title+'</h1>'+
                            '<div id="bodyContent">'+
                            '<div class="col-sm-12" style="max-width: 300px !important" ><p>Located at '+this.address+'</p><p>'+this.desc+'</p></div>'+
                            '</div>'+'<div class="col-sm-12" ><p>Latitude : '+this.lat+' | Longitude : '+this.long+'</p></div></div>'+
                            '</div>'+
                            '</div>';
                            ...
                            infoWindow.setContent(contentString);
                            infoWindow.open(map, this);
                            var poLoc = new google.maps.LatLng(pops[o][1], pops[o][2]); //Makes a latlng
                            map.panTo(poLoc);
                            map.setZoom(14);
	            ...
	            $('#assetsTtl').append('Assets').show('slow');
                    if(sbu != 'sbu'){
	                   $('#assetsInfo').append('Total Assets in <strong>'+ assetsData["name"] +'</strong>').show('slow');
                         ...
                         $('#assetsInfo').append('<strong>From '+(assetsData["pop_ttl"] - assetsData["popCustomer"])+' POP <br>and '+assetsData["popCustomer"]+' Customer Site <br>in '+ assetsData["name"] +'</strong>').show('slow');
                    }
	        }
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDYxcj9zQErZ6KkleQahg_vuY2cRg5yfEU&callback=initMap">
</script>
