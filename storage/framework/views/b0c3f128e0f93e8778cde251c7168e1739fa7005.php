...
<?php $__env->startSection('content'); ?>
	<div class="big-screen" ><img src="images/login-img.png" class="img-responsive" style=" height: 100vh; width: 70%; position: absolute;">
       	<div style="width: 30%; background-color: #ffffff; height: 100vh; position: relative;" class="pull-right">
	       	<div class="middle-box text-center loginscreen"  style="margin-top: 35%">
		        <div class-="col-md-12" >
		            <h2 style="font-size: 36px"><strong>ABAH</strong></h2>
            ...
            <?php echo csrf_field(); ?>
	            ...
	            <p class="m-t" >PD.<strong> Kebersihan - Bandung </strong><small>© 2017</small></p>
	        </div>
	    </div>
	</div>
