                ...
                <ul class="nav nav-second-level collapse">
                  ...
                  <?php if(Sentinel::getUser()->hasAnyAccess(['item*','kategori*'])): ?>
                    <li <?php echo e((Request::is('item*','kategori*') ? 'class=active' : '')); ?>>
                      <a href="<?php echo e(route('item.index')); ?>">Data Barang</a>
                    </li>
                    <?php endif; ?>
