...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="active">
            <a href="<?php echo e(url('brand')); ?>"> Brand
        </li> /
        <li class="active">
            <a href="<?php echo e(url('template')); ?>"> Template
        </li> /
        <li class="active">
                <a href="#">
                    Add New
    ...
    <?php echo Form::open(['url' => 'templates', 'class' => 'form-horizontal']); ?>
		...
		<div class="form-group <?php echo e($errors->has('name') ? 'has-error' : ''); ?>">
			<?php echo Form::label('kategori', 'Category: ', ['class' => 'col-sm-1 control-label']); ?>

			<div class="col-sm-5">
				<select class="form-control select2_demo_1" name="kategori">
					<option value="uncategories">Pilih Category</option>
					<?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				      <?php if($template->depth==0): ?>
