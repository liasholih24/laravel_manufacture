                    ...
                    <div class="ibox-content p-xl">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <h4 class="text-navy"><?php echo e($pembelian->code); ?> </h4>
                                    <address>
                                        <h4><strong><?php echo e($pembelian->name); ?></strong></h4>
                                    </address>
                                    <p>
                                       
                                        <span><strong>Tgl:</strong> <?php echo e($pembelian->created_at); ?></span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <table class="table invoice-total">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(number_format($pembelian->total_rp,0)); ?></td>
                                </tr>
                                <tr>
                                    <td><strong>Total (kg) :</strong></td>
                                    <td><?php echo e(number_format($pembelian->total_kg)); ?></td>
                                </tr>
