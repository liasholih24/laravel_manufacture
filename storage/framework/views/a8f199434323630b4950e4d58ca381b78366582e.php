...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="">
            <a href="<?php echo e(url('sedekah')); ?>">  Sedekah
        </li>
        /
        <li class="">
                <a href="#">
...
<div class="row ibox-content" style="min-height: 65vh; ">
  ...
  <?php echo Form::model($sedekah, [
      'method' => 'PATCH',
      'url' => ['sedekah', $sedekah->id],
    ...
    <div class="form-group <?php echo e($errors->has('norek') ? 'has-error' : ''); ?>">
                ...
                <select name="gudang" class="col-sm-12 form-control Gudang chosen-select" style="width:350px;" tabindex="2" id="gudang" data-fplaceholder="Gudang">
                                  <?php $__currentLoopData = $gudangs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gudang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($gudang->id); ?>" <?php if($gudang->id == $sedekah->gudang) echo "selected"; ?>><?php echo e($gudang->code); ?> - <?php echo e($gudang->name); ?></option>
         ...
         <div class="hr-line-dashed"></div>
          ...
          <div class="col-sm-4 <?php echo e($errors->has('created_at') ? 'has-error' : ''); ?>">
              ...
              <?php echo $errors->first('created_at', '<p class="help-block">:message</p>'); ?>
                ...
                <?php echo Form::label('perusahaan', 'Donatur*', ['class' => 'col-sm-2 control-label']); ?>

                <div class="col-sm-8">
                <?php echo Form::text('perusahaan', null, ['class' => 'form-control']); ?>
        ...
        <tbody>
            ...
            <td data-name="sampah">
              <select  name="sampah[]" class="form-control Sampah " data-placeholder="Pilih Sampah"  style="width:250px;">
                    <option value=""></option>
            ...
            <td data-name="jumlah">
                <?php echo Form::number('jumlah[]', $detail->jumlah, ['class' => 'form-control Jumlah Jumlah2','step'=>'any']); ?>

            </td>
            <td data-name="harga_beli">
                <?php echo Form::number('harga_beli[]', $detail->harga_beli, ['class' => 'form-control','readonly'=>'readonly']); ?>
        ...
        <tfoot>
           <tr>
            ...
            <td colspan="1">
             ...
             <?php echo Form::text('code', $sedekah->code, ['class' => 'form-control','id'=>'trx_code']); ?>
