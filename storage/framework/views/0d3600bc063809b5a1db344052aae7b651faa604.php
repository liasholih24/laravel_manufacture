...
<script>
    $(document).ready(function(){
      ...
      var table = $('#tblsedekah').DataTable({
       processing: true,
       serverSide: true,
       ajax: '<?php echo e(url("/sedekahapi")); ?>',
       columns: [
           {data: 'id', name: 'id'},
           {data: 'code', name: 'code'},
   ...
   $('#filter').on('click', function(e){
     ...
     var from = $('#from').val();
     var to = $('#to').val();
     var uwu = "<?php echo e(url('/sedekahapi')); ?>?perusahaan="+perusahaan+"&fromDate="+from+"&toDate="+to;
     console.log(uwu);
     table.ajax.url("<?php echo e(url("/sedekahapi")); ?>?perusahaan="+perusahaan+"&fromDate="+from+"&toDate="+to);
     table.ajax.reload();
   });
