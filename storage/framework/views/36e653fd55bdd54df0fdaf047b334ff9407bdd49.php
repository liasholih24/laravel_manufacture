...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="">
            <a href="<?php echo e(url('sedekah')); ?>"> Transaksi</a>
        </li>
        <li class="">
            <a href="<?php echo e(url('sedekah')); ?>"> Sedekah Sampah</a>
        </li>
...
<div class="row ibox-content" style="min-height: 65vh; ">
   ...
   <?php echo Form::open(['url' => 'sedekah', 'class' => 'form-horizontal']); ?>
    ...
    <div class="form-group <?php echo e($errors->has('norek') ? 'has-error' : ''); ?>">
        ...
        <tbody>
            ...
            <td data-name="harga_beli">
                <?php echo Form::number('harga_beli[]', null, ['class' => 'form-control','readonly'=>'readonly']); ?>
