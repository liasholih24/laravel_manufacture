                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="stat-percent font-bold text-success"><?php echo e(empty($sampah)?"0": $sampah); ?> kg 
                                 ...
                                 <small> dari <?php echo e(empty($nasabah)?"0": $nasabah); ?> kandang</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <h1 class="no-margins"><?php echo e(empty($penjualan_rp)?"0": number_format($penjualan_rp,0)); ?></h1>
                                <div class="stat-percent font-bold text-navy"><?php echo e(empty($penjualan_kg)?"0": $penjualan_kg); ?> kg </div>
                                <small>dari <?php echo e(empty($perusahaan)?"0": $perusahaan); ?> kandang</small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3">
                                ...
                                <div class="col-lg-3">
                                    <ul class="stat-list">
                                        <li>
                                            ...
                                            <small>Pemakaian Pakan (Rp.) <?php echo e(date('M Y')); ?></small>
                                        ...
                                        <li>
                                            ...
                                            <small>Pemakaian Pakan (kg) <?php echo e(date('M Y')); ?></small>
                                         ...
                                         <li>
                                            ...
                                            <small>Hasil Produksi (Rp.) <?php echo e(date('M Y')); ?> </small>
                                        ...
                                        <li>
                                            ...
                                            <small>Hasil Produksi (kg) <?php echo e(date('M Y')); ?></small>
