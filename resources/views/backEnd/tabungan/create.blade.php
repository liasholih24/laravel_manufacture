...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="">
            <a href="{{ url('nasabah') }}"> Transaksi</a>
        </li>
        <li class="">
            <a href="{{ url('nasabah') }}"> Tabungan Nasabah</a>
        </li>
...
<div class="row ibox-content" style="min-height: 65vh; ">
   ...
   {!! Form::open(['url' => 'tabungan', 'class' => 'form-horizontal']) !!}
   {!! Form::hidden('created_by', Sentinel::getUser()->id, ['class' => 'form-control']) !!}
    ...
    {!! Form::hidden('unit_kerja', Sentinel::getUser()->unit_id, ['class' => 'form-control']) !!}
   
               <div class="form-group {{ $errors->has('norek') ? 'has-error' : ''}}">
                {!! Form::label('norek', 'Nasabah*', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-8">
                <select name="norek" class="col-sm-12 form-control Norek chosen-select" style="width:350px;" tabindex="2" id="norek" data-fplaceholder="Nasabah">
                                 <option value=""></option>
                                  @foreach($nasabahs as $nasabah)
                                    <option value="{{$nasabah->norek}}">{{$nasabah->norek}} - {{$nasabah->nama_depan}} {{$nasabah->nama_belakang}}</option>
                                  @endforeach
                                </select>
      ...
      <a id="closeNasabah" class="detail2 btn btn-md btn-success pull-right">  <i class="fa fa-times-circle" ></i> Tutup</a>
        ...
        <tfoot>
           <tr>
            ...
            <td colspan="1">
                {!! Form::number('saldo_sampah', null, ['class' => 'form-control','readonly'=>'readonly','id'=>'saldo_sampah']) !!}
            </td>
            <td colspan="1">
                {!! Form::number('kredit', null, ['class' => 'form-control','readonly'=>'readonly','id'=>'kredit','id'=>'kredit']) !!}
            </td>
          </tr>
        </tfoot>
        </table>
             ...
             <div id="showDebit">
                ...
                {!! Form::label('debit', 'Debit', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-6">
            ...
            <div class="hr-line-dashed"></div>
             ...
             <div class="form-group ">
                ...
                <div class="col-sm-4 col-xs-12 {{ $errors->has('notes') ? 'has-error' : ''}}">
          ...
          <div class="col-sm-4 {{ $errors->has('created_at') ? 'has-error' : ''}}">
             ...
             {!! Form::hidden('trx_code', null, ['class' => 'form-control','id'=>'trx_code']) !!}
...
// END DYNAMIC TABLE
     ...
     if ($(this).find(':selected').val() != '') { 
      ...
      var val     = $(this).find(':selected').val();
         ...
         var norek =  $('#norek').val(),
             item_d  = $(this).find(':selected').data(),
             url     = '{{url("/gettrxcode?norek=")}}'+norek+'&code='+val+'';
    ...
    $('#showNasabah').on('click', function(e){
      ...
      url     =  '{{url("/datanasabah?norek=")}}'+norek;
