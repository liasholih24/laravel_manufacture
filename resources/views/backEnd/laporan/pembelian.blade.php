...
<div class="ibox float-e-margins">
    ...
    <div class="ibox-title row">
        <ol class="breadcrumb col-sm-7 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
          ...
          <a href="{{ url('laporan/pembelian')}}" class="btn btn-sm btn-outline btn-primary pull-right">
...
<script>
   ...
   $('#filter').on('click', function(e){
     ...
     var from = $('#from').val();
     var to = $('#to').val();
     table.ajax.url("{{url("/pembelianapi")}}?fromDate="+from+"&toDate="+to+"&gudang="+gudang);
     table.ajax.reload();
   });
