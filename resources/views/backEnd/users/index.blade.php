...
<div class="col-lg-12 detail_content2" style="background-color: white">
            ...
            <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 13px; padding-top: 6px; ">
              <li>
                  Select Role 
              </li>
            </ol>
                ...
                @endif
              <div class="col-sm-2" style="position:absolute;margin-left: 60px;">
                <select class="select2_demo_1"  style="" onchange="if (this.value) window.location.href=this.value">
