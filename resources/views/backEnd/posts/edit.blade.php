...
<div class="row ibox-content" style="min-height: 65vh; ">
  ...
  {!! Form::model($post, [
	...
	<div class="form-group {{ $errors->has('thumbnail') ? 'has-error' : ''}}">
			...
			<div class="col-sm-6">
				<div class="image-crop">
					<img id="imagePreview" src= "{{url('/'.$post->thumbnail)}}" style="max-height:200px">
				</div>
				{{-- <h4>Thumbnail</h4> --}}
				<p>
						Unggah thumbnail
	...
	<div class="form-group {{ $errors->has('author') ? 'has-error' : ''}}">
			...
			<div class="col-sm-6">
					{!! Form::text(null,$post->getAuthor->first_name.' '.$post->getAuthor->last_name, ['class' => 'form-control','readonly']) !!}
	...
	<div class="form-group {{ $errors->has('date_posted') ? 'has-error' : ''}}">
			...
			<div class="col-sm-6">
				<input type="datetime-local" name="date_posted" class="form-control" value="{{date("Y-m-d\TH:i",strtotime($post->date_posted))}}" readonly>
