                    ...
                    <div class="ibox-content p-xl">
                            <div class="row">
                                ...
                                <div class="col-sm-6 text-right">
                                    <h4 class="text-navy">{{$pembelian->code}} </h4>
                                    <address>
                                        <h4><strong>{{$pembelian->name}}</strong></h4>
                                    </address>
                                    <p>
                                       
                                        <span><strong>Tgl:</strong> {{ $pembelian->created_at }}</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <table class="table invoice-total">
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($pembelian->total_rp,0) }}</td>
                                </tr>
                                <tr>
                                    <td><strong>Total (kg) :</strong></td>
                                    <td>{{ number_format($pembelian->total_kg) }}</td>
                                </tr>
