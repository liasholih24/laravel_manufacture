...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="">
            <a href="{{ url('pembelian') }}">  Pembelian
        </li>
        /
        <li class="">
                <a href="#">
    ...
    <div class="form-group {{ $errors->has('norek') ? 'has-error' : ''}}">
                ...
                <select name="gudang" class="col-sm-12 form-control Gudang chosen-select" style="width:350px;" tabindex="2" id="gudang" data-fplaceholder="Gudang">
                                  ...
                                  @foreach($gudangs as $gudang)
                                    <option value="{{$gudang->id}}" <?php if($pembelian->gudang == $gudang->id)echo"selected";?>>{{$gudang->code}} - {{$gudang->name}}</option>
                                  @endforeach
                                </select>
        ...
        <div class="form-group ">
            ...
            {!! Form::hidden('code', $pembelian->code, ['class' => 'form-control','id'=>'code']) !!}
 <div class="hr-line-dashed"></div> 
    <div class="row clearfix">
        ...
        <tbody>
            ...
            <td data-name="harga_beli">
                {!! Form::number('harga_beli[]', $detail->harga_beli, ['class' => 'form-control HJ HJ2']) !!}
        ...
        <tfoot>
           <tr>
            ...
            <td colspan="1">
                {!! Form::number('total_kg', null, ['class' => 'form-control','id'=>'total_kg']) !!}
            </td>
            <td colspan="1">
