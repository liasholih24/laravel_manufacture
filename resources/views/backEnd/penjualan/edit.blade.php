...
<div class="wrapper wrapper-content">
   ...
   <ol class="breadcrumb col-sm-6 col-xs-12" style="font-size: 14px; padding-top: 6px; ">
        <li class="">
            <a href="{{ url('penjualan') }}">  Penjualan
        </li>
        /
        <li class="">
                <a href="#">
    ...
    <div class="form-group {{ $errors->has('norek') ? 'has-error' : ''}}">
                ...
                <select name="gudang" class="col-sm-12 form-control Gudang chosen-select" style="width:350px;" tabindex="2" id="gudang" data-fplaceholder="Gudang">
                                  ...
                                  @foreach($gudangs as $gudang)
                                    <option value="{{$gudang->id}}" <?php if($penjualan->gudang == $gudang->id)echo"selected";?>>{{$gudang->code}} - {{$gudang->name}}</option>
                                  @endforeach
                                </select>
            ...
            <div class="hr-line-dashed"></div> 
               <div class="form-group {{ $errors->has('norek') ? 'has-error' : ''}}">
                {!! Form::label('perusahaan', 'Perusahaan*', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-8">
                 {!! Form::text('perusahaan',null, ['class' => 'form-control','placeholder' => 'Nama Bandar/Perusahaan.']) !!}
        ...
        <div class="form-group ">
            ...
            {!! Form::hidden('code', $penjualan->code, ['class' => 'form-control','id'=>'code']) !!}
 <div class="hr-line-dashed"></div> 
    <div class="row clearfix">
        ...
        <tbody>
            ...
            <td data-name="harga_beli">
                {!! Form::number('harga_jual[]', null, ['class' => 'form-control HJ HJ2']) !!}
           ...
           <?php $i++; ?>
            ...
            <td data-name="sampah">
              <select  name="sampah[]" class="form-control Sampah" data-placeholder="Pilih Sampah" id="sampah" style="width:250px;">
                     @foreach($sampahs as $sampah)
                        <option value="{{$sampah->id}}" <?php if($detail->sampah == $sampah->id)echo"selected";?>>{{$sampah->code}} - {{$sampah->name}}</option>
                     @endforeach  
                </select>

            </td>
            <td data-name="satuan">
                <select  name="satuan[]" class="form-control Satuan" data-placeholder="Pilih Satuan" id="satuan{{$i}}" style="width:200px;">
                     @foreach($satuans as $satuan)
                        <option value="{{$satuan->code}}" <?php if($detail->satuan == $satuan->code)echo"selected";?>>{{$satuan->name}}</option>
                     @endforeach  
                </select>

            </td>
            <td data-name="jumlah">
                {!! Form::number('jumlah[]', $detail->jumlah, ['class' => 'form-control Jumlah','step'=>'any']) !!}
                 </td>
            <td data-name="harga_jual">
                {!! Form::number('harga_jual[]', $detail->harga_jual, ['class' => 'form-control HJ']) !!}

            </td>
            <td data-name="nilai_kg">
                {!! Form::number('nilai_kg[]', $detail->nilai_kg, ['class' => 'form-control Nkg','readonly'=>'readonly']) !!}
            </td>
            <td data-name="nilai_rp">
                {!! Form::number('nilai_rp[]', $detail->nilai_rp, ['class' => 'form-control Nrp','readonly'=>'readonly']) !!}
            </td>
