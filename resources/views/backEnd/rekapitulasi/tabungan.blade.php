                ...
                <ol class="dd-list">
                    <li class="dd-item ">
                        <div class="dd-handle dd-nodrag" style="margin-left: auto; margin-right: auto">
                            <a href="{{ url('rekapitulasi/tabungan')}}">
...
<script>
    $(document).ready(function(){
     ...
     table.ajax.url("{{url("/rektabunganapi")}}?unit="+unit+"&status="+status+"&kosong="+kosong+"&fromDate="+from+"&toDate="+to);
     table.ajax.reload();
   });
