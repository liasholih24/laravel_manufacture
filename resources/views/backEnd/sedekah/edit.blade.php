    ...
    <div class="form-group {{ $errors->has('norek') ? 'has-error' : ''}}">
                ...
                <select name="gudang" class="col-sm-12 form-control Gudang chosen-select" style="width:350px;" tabindex="2" id="gudang" data-fplaceholder="Gudang">
                                  @foreach($gudangs as $gudang)
                                    <option value="{{$gudang->id}}" <?php if($gudang->id == $sedekah->gudang) echo "selected"; ?>>{{$gudang->code}} - {{$gudang->name}}</option>
                                  @endforeach
                                </select>
         ...
         <div class="hr-line-dashed"></div>
          ...
          <div class="col-sm-4 {{ $errors->has('created_at') ? 'has-error' : ''}}">
              ...
              {!! $errors->first('created_at', '<p class="help-block">:message</p>') !!}
                ...
                {!! Form::label('perusahaan', 'Donatur*', ['class' => 'col-sm-2 control-label']) !!}
                <div class="col-sm-8">
        ...
        <tbody>
            ...
            <td data-name="jumlah">
                {!! Form::number('jumlah[]', $detail->jumlah, ['class' => 'form-control Jumlah Jumlah2','step'=>'any']) !!}
            </td>
            <td data-name="harga_beli">
                {!! Form::number('harga_beli[]', $detail->harga_beli, ['class' => 'form-control','readonly'=>'readonly']) !!}
        ...
        <tfoot>
           <tr>
            ...
            <td colspan="1">
             ...
             {!! Form::text('code', $sedekah->code, ['class' => 'form-control','id'=>'trx_code']) !!}
     ...
     <div class="form-group">
      ...
      <a href="{{ url('nasabah') }}" class="detail2 btn btn-md btn-outline btn-default pull-left">  <i class="fa fa-times-circle" ></i> Batal</a>
      </a>
    </div>
    </div>
    {!! Form::close() !!}
