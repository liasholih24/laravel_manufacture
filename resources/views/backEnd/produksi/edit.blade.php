...
<div class="row ibox-content" style="min-height: 65vh; ">
    ...
    <h4>Info</h4>
                ...
                <div class="col-sm-5">
                    {!! Form::text('prod_tgl', null, ['id' => 'prod_tgl','class' => 'form-control','data-date-format'=>'yyyy-mm-dd','placeholder' => $datenow]) !!}
            ...
            <div class="form-group {{ $errors->has('kandang') ? 'has-error' : ''}}">
                ...
                <div class="col-sm-5">
                    {{ Form::select('kandang', $kandangs, null, ['class' => 'form-control select2 Kandang','placeholder' => 'Pilih Kandang','disabled'=>'disabled']) }}
